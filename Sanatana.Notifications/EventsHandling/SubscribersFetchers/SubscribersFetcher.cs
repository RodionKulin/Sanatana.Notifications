...
namespace Sanatana.Notifications.EventsHandling
{
        ...
        where TKey : struct
    {
        ...
        //method
        public virtual EventHandleResult<Subscriber<TKey>> Select(EventSettings<TKey> eventSettings, SignalEvent<TKey> signalEvent)
        {
        ...
        protected virtual EventHandleResult<Subscriber<TKey>> ConvertAddressesToSubscribers(EventSettings<TKey> settings, SignalEvent<TKey> signalEvent)
        {
